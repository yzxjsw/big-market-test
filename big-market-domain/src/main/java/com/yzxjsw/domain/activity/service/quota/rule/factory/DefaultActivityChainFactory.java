package com.yzxjsw.domain.activity.service.quota.rule.factory;
...
/**
 * DefaultActivityChainFactory 责任链工厂
 *
 * @author yezhenxiong
 * @version 2024/07/22 16:27
 **/
@Service
public class DefaultActivityChainFactory {
    ...
    public enum ActionModel {
        ...
        activity_base_action("activity_base_action", "活动的日期，状态校验"),
