package com.yzxjsw.test.domain.award;
...
public class AwardServiceTest {
    ...
    public void test_saveUserAwardRecord() throws InterruptedException {
        for (int i = 0; i < 100; i++) {
            ...
            userAwardRecordEntity.setUserId("yzx");
            userAwardRecordEntity.setActivityId(1001L);
            userAwardRecordEntity.setStrategyId(1002L);
